package idusw.springboot.boardthyemleaf.service;

import idusw.springboot.boardthyemleaf.domain.Memo;
import idusw.springboot.boardthyemleaf.entity.MemoEntity;
import idusw.springboot.boardthyemleaf.repository.MemoRepository;
...
public class MemoServiceImpl implements MemoService {
  ...
  public List<Memo> initialize() {
    ...
    IntStream.rangeClosed(1,10).forEach(i -> {
      MemoEntity memo = MemoEntity.builder().memoText("jhm : " + i).build();
